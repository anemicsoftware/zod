...
class ZodArray extends ZodType {
    _parse(input) {
        ...
        if (def.uniq) {
            ...
            for (const elem of ctx.data) {
                if (typeof elem !== "object") {
                    if (testObj[elem]) {
                        (0, parseUtil_1.addIssueToContext)(ctx, {
                            code: ZodError_1.ZodIssueCode.duplicate_element,
                        });
                        status.dirty();
                        break;
                    }
        ...
        if (def.uniqDeep) {
            ...
            for (const elem of ctx.data) {
                if (typeof elem !== "object") {
                    if (testObj[elem]) {
                        (0, parseUtil_1.addIssueToContext)(ctx, {
                            code: ZodError_1.ZodIssueCode.duplicate_element_deep,
                        });
                        status.dirty();
                        break;
                    }
                    ...
                    if (objects.some((test) => util_1.util.isEqual(test, elem))) {
                        (0, parseUtil_1.addIssueToContext)(ctx, {
                            code: ZodError_1.ZodIssueCode.duplicate_element_deep,
                        });
                        status.dirty();
        ...
        if (def.uniqBy) {
            ...
            for (const elem of ctx.data) {
                ...
                if (typeof val !== "object") {
                    if (testObj[val]) {
                        (0, parseUtil_1.addIssueToContext)(ctx, {
                            code: ZodError_1.ZodIssueCode.duplicate_element_by,
                        });
                        status.dirty();
                        break;
                    }
        ...
        if (def.uniqWith) {
            const objects = [];
            for (const elem of ctx.data) {
                if (objects.some((test) => { var _a; return (_a = def.uniqWith) === null || _a === void 0 ? void 0 : _a.call(def, test, elem); })) {
                    (0, parseUtil_1.addIssueToContext)(ctx, {
                        code: ZodError_1.ZodIssueCode.duplicate_element_with,
                    });
                    status.dirty();
                    break;
                }
