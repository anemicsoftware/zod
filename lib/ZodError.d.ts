...
export declare const ZodIssueCode: {
    ...
    duplicate_element_deep: "duplicate_element_deep";
    duplicate_element_by: "duplicate_element_by";
    duplicate_element_with: "duplicate_element_with";
...
export interface ZodDuplicateElement extends ZodIssueBase {
...
export declare type ZodIssueOptionalMessage = ZodInvalidTypeIssue | ZodInvalidLiteralIssue | ZodUnrecognizedKeysIssue | ZodInvalidUnionIssue | ZodInvalidUnionDiscriminatorIssue | ZodInvalidEnumValueIssue | ZodInvalidArgumentsIssue | ZodInvalidReturnTypeIssue | ZodInvalidDateIssue | ZodInvalidStringIssue | ZodTooSmallIssue | ZodTooBigIssue | ZodDuplicateElement | ZodDuplicateElementDeep | ZodDuplicateElementBy | ZodDuplicateElementWith | ZodInvalidIntersectionTypesIssue | ZodNotMultipleOfIssue | ZodNotFiniteIssue | ZodCustomIssue;
